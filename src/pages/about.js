        ...
        <div className="container-lg">
          <div className="row">
            <div className="col-12">
              ...
              {/* Slider */}
              <div className="flickity-buttons-overlap border border-7 border-white shadow-lg">
                <div className="w-100">
                  {/* Image */}
                  <img
                    className="img-fluid"
        ...
        <div className="container-lg">
          <div className="row justify-content-center">
            <div className="col-md-10 col-lg-8 text-center">
              ...
              {/* Preheading */}
              <h6 className="text-uppercase text-primary mb-5">About us</h6>
          ...
          <div className="container-sm" style={{ maxWidth: "768px" }}>
            <p className="fs-sm text-white-60 mb-0 text-center">
              Project manner PD is a Lagos based full-service digital marketing
              agency providing a wide range of digital services across Lagos,
              Benin, Abuja, Port Harcourt, and other cities in Nigeria. As a
              very ambitious company, who has a strong desire for success, we
              utilise a unique and bespoke digital marketing techniques to
              deliver outstanding results for our clients.
            </p>
            <p className="fs-sm text-white-60 mb-0 text-center">
              We have a ‘winning’ team of digital experts, who are focused on
              delivering long-term results for our clients. Our forward-thinking
              approach, coupled with the adoption of new technology and
              processes, has proved to be a winning formula and has helped
              businesses to build a successful online presence through digital
              marketing.
            </p>
            <p className="fs-sm text-white-60 mb-0 text-center">
              At Project Manner PD, we do not go the easy way through shortcuts
              and cutting corners, but we go the extra mile in building a
              solution that is&nbsp;long-lasting and future-proofed. If you are
              looking to work with a digital marketing agency who is obsessed
              with results, with an eye to the future, get in touch now to
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="d-flex mt-8 mt-md-9">
                ...
                <div className="ms-5">
                  ...
                  <p className="fs-sm text-white-60 mb-0">
                    We like to brag about our results. All our services are
                    strategically put together to help our clients achieve their
                    objectives. Our results are sustainable and future-proof.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4">
              ...
              <div className="d-flex mt-8 mt-md-9">
                ...
                <div className="ms-5">
                  ...
                  {/* Text */}
                  <p className="fs-sm text-white-60 mb-0">
                    No single day is the same for us at PMPD. Our solutions are
                    unique and tailored, as we understand that no two clients
                    are the same. We are constantly working on refining our
                    processes to meet all standards.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4">
              ...
              <div className="d-flex mt-9">
                ...
                <div className="ms-5">
                  ...
                  <p className="fs-lg fw-bold text-white mb-1">
                    {" "}
                    We're through and transparent
                  </p>

                  {/* Text */}
                  <p className="fs-sm text-white-60 mb-0">
                    We pay attention to every detail, we dig into our client’s
                    business and analyse their competitors. We leave no stone
                    unturned. We are very open and upfront with our clients. No
                    surprises, No funny business!
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-4">
              ...
              <div className="d-flex mt-8 mt-md-9">
                ...
                <div className="ms-5">
                  {/* Title */}
                  <p className="fs-lg fw-bold text-white mb-1">
                    We're local and international company
                  </p>

                  {/* Text */}
                  <p className="fs-sm text-white-60 mb-0">
                    We have access to broad resources which gives our clients
                    certain advantages. We have an excellent understanding of
                    our locality and good business connections on the
            ...
            <div className="col-md-6 col-lg-4">
              ...
              <div className="d-flex mt-8 mt-md-9">
                ...
                <div className="ms-5">
                  {/* Title */}
                  <p className="fs-lg fw-bold text-white mb-1">
                    We have a team of dynamic & energetic professionals
                  </p>

                  {/* Text */}
                  <p className="fs-sm text-white-60 mb-0">
                    Our team shares a great professional bond which is geared
                    towards delivering top-notch digital services to our
                    clients. We make work fun and exciting for all. Be part of
                    the winning team.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-6 col-lg-4">
              ...
              <div className="d-flex mt-8 mt-md-9">
                ...
                <div className="ms-5">
                  {/* Title */}
                  <p className="fs-lg fw-bold text-white mb-1">
                    We are prompt, effective & affordable
                  </p>

                  {/* Text */}
                  <p className="fs-sm text-white-60 mb-0">
                    We keep our clients informed and updated, all through the
                    process while delivering a prompt service. You will not
                    break the bank with our services, yet we do not compromise
                    on the quality of service. In fact, we are efficacious!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-md-5 order-md-1 pt-11 pt-md-0 pb-md-12">
              ...
              <div className="position-relative">
                ...
                {/* Map */}
                <div
                  className="ratio shadow-lg header-img"
            ...
            <div className="col-md-6 col-lg-5 order-md-0 py-11 py-md-13">
              {/* Heading */}
              <h2 className="display-4 mb-4">Our values</h2>

              {/* Text */}
              <p className="text-muted">
                We are everything that you would expect from a digital marketing
                agency; result-oriented, technology-driven, experienced,
                transparent, accountable, flexible and creative. We have built a
                team of digital experts around our core values, which has helped
                us to work together and more effectively.
              </p>

              <h5 className="h6 text-uppercase">
                Here are the core-values of PMPD
              </h5>
              <p className="text-muted">
                Accountability, Best People, Customer Satisfaction, Flexibility,
                Fun, Integrity, Passion, Results-driven, Teamwork, Transparency
              </p>
            </div>
          </div>
        </div>
